...
static const struct camss_format_info formats_rdi_sdm845[] = {
	{ MEDIA_BUS_FMT_UYVY8_2X8, V4L2_PIX_FMT_UYVY, 1,
	  { { 1, 1 } }, { { 1, 1 } }, { 16 } },
	{ MEDIA_BUS_FMT_VYUY8_2X8, V4L2_PIX_FMT_VYUY, 1,
	  { { 1, 1 } }, { { 1, 1 } }, { 16 } },
...
static const struct camss_format_info formats_pix_sdm845[] = {
	{ MEDIA_BUS_FMT_YUYV8_1_5X8, V4L2_PIX_FMT_NV12, 1,
	  { { 1, 1 } }, { { 2, 3 } }, { 8 } },
	{ MEDIA_BUS_FMT_YVYU8_1_5X8, V4L2_PIX_FMT_NV12, 1,
	  { { 1, 1 } }, { { 2, 3 } }, { 8 } },
		       ...
		       const char *name, int is_pix)
{
	...
	}  else if (video->camss->version == CAMSS_SDM845) {
		if (is_pix) {
			video->formats = formats_pix_sdm845;
			video->nformats = ARRAY_SIZE(formats_pix_sdm845);
		} else {
			video->formats = formats_rdi_sdm845;
			video->nformats = ARRAY_SIZE(formats_rdi_sdm845);
		}
	} else {
